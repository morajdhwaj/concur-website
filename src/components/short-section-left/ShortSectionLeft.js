...
import './_short-section-left.scss';

const ShortSectionLeft = () => {
  return (
    <div className='short-section-left'>
      <div className='short-section-left-div2'>
        <h5 className='short-section-left-div2-title'>
          AUTOMATE DATA DISCOVERY
        </h5>
        <h2 className='short-section-left-div2-h'>No more flying blind</h2>
        <p className='short-section-left-div2-p'>
      ...
      <div className='short-section-left-div1'>
        <img
          src='https://www.datocms-assets.com/16414/1691190504-image-6.svg'
          alt=''
          className='short-section-left-div1-img'
        />
      </div>
    </div>
  );
